      ...
      <div className="min-h-screen flex flex-col justify-center items-center">
        ...
        <div className="bg-white p-8 rounded-lg box-shadow-3d w-full sm:w-96">
          ...
          <form>
            ...
            <div className="mb-6">
              <button type="submit" className="w-full bg-indigo-600 text-white py-2 px-4 rounded-lg hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700">Reset Password</button>
            </div>
          </form>
